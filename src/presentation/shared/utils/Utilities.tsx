        ...
        <AlertDialog.Content className="AlertDialogContent">
          ...
          <div style={{ display: "flex", gap: 25, justifyContent: "flex-end" }}>
            ...
            <AlertDialog.Action asChild>
              <button className="Button red" onClick={onDeleteTask}>
                {" "}
                Sim, deletar tarefa
              </button>
            </AlertDialog.Action>
...
export const ErrorToastDialog = ({
  ...
  return (
    <Toast.Provider swipeDirection="right">
      <Toast.Root className="ToastRoot" open={isOpen} onOpenChange={handleOpen}>
        <Toast.Title className="ToastTitle">Ocorreu um erro</Toast.Title>
        {description && (
          <Toast.Description asChild>
            <span className="ToastDescription">{description}</span>
          </Toast.Description>
        ...
        <Toast.Action className="ToastAction" asChild altText="confirm">
          <button className="Button small red" onClick={handleClose}>
            OK
          </button>
        </Toast.Action>
      </Toast.Root>
